...
('gm fly', 'Syntax: .gm fly [on/off]', 'Enable/disable gm fly mode.', @GMLEVEL_GM),
...
('gobject delete', 'Syntax: .gobject delete $go_guid', 'Delete gameobject with guid $go_guid.', @GMLEVEL_MODERATOR),
...
('gobject move', 'Syntax: .gobject move $goguid [$x $y $z]', 'Move gameobject $goguid to character coordinates (or to ($x,$y,$z) coordinates if its provide).', @GMLEVEL_MODERATOR),
...
('gobject set phase', 'Syntax: .gobject set phase $guid $phasemask', 'Gameobject with DB guid $guid phasemask changed to $phasemask with related world vision update for players. Gameobject state saved to DB and persistent.', @GMLEVEL_MODERATOR),
('gobject target', 'Syntax: .gobject target [$go_id|$go_name_part]', 'Locate and show position nearest gameobject. If $go_id or $go_name_part provide then locate and show position of nearest gameobject with gameobject template id $go_id or name included $go_name_part as part.', @GMLEVEL_MODERATOR),
('gobject turn', 'Syntax: .gobject turn $goguid ', 'Set for gameobject $goguid orientation same as current character orientation.', @GMLEVEL_MODERATOR),
...
('goto creature', 'Syntax: .goto creature $creature_guid', 'Teleport your character to creature with guid $creature_guid.\n.gocreature $creature_name\nTeleport your character to creature with this name.\n.gocreature id $creature_id\nTeleport your character to a creature that was spawned from the template with this entry.\n*If* more than one creature is found, then you are teleported to the first that is found inside the database.', @GMLEVEL_MODERATOR),
...
('goto object', 'Syntax: .goto object $object_guid', 'Teleport your character to gameobject with guid $object_guid', @GMLEVEL_MODERATOR),
...
('modify phase', 'Syntax: .modify phase $phasemask', 'Selected character phasemask changed to $phasemask with related world vision update. Change active until in game phase changed, or GM-mode enable/disable, or re-login. Character pts pasemask update to same value.', @GMLEVEL_MODERATOR),
...
('npc add', 'Syntax: .npc add $creatureid', 'Spawn a creature by the given template id of $creatureid.', @GMLEVEL_MODERATOR),
('npc add item', 'Syntax: .npc add item $itemId [$$maxcount][$$incrtime][$$extendedcost]r', 'Add item $itemid to item list of selected vendor. Also optionally set max count item in vendor item list and time to item count restoring and items ExtendedCost.', @GMLEVEL_GM),
('npc add temp', 'Syntax: .npc add temp', 'Adds temporary NPC, not saved to database.', @GMLEVEL_GM),
...
('npc info', 'Syntax: .npc info', 'Display a list of details for the selected creature.\n\nThe list includes:\n- GUID, Faction, NPC flags, Entry ID, Model ID,\n- Level,\n- Health (current/maximum),\n\n- Field flags, dynamic flags, faction template, \n- Position information,\n- and the creature type, e.g. if the creature is a vendor.', @GMLEVEL_MODERATOR),
('npc move', 'Syntax: .npc move [$creature_guid]', 'Move the targeted creature spawn point to your coordinates.', @GMLEVEL_MODERATOR),
('npc playemote', 'Syntax: .npc playemote $emoteid', 'Make the selected creature emote with an emote of id $emoteid.', @GMLEVEL_MODERATOR),
('npc say', 'Syntax: .npc say $message', 'Make selected creature say specified message.', @GMLEVEL_MODERATOR),
('npc set data', 'Syntax: .npc set data $field $data', 'Sets data for the selected creature. Used for testing Scripting', @GMLEVEL_ADMIN),
('npc set entry', 'Syntax: .npc set entry $entry', 'Switch selected creature with another entry from creature_template. - New creature.id value not saved to DB.', @GMLEVEL_GM),
...
('npc set flag', 'Syntax: .npc set flag $npcflag', 'Set the NPC flags of creature template of the selected creature and selected creature to $npcflag. NPC flags will applied to all creatures of selected creature template after server restart or grid unload/load.', @GMLEVEL_ADMIN),
('npc set level', 'Syntax: .npc set level $level', 'Change the level of the selected creature to $level.\n\n$level may range from 1 to (CONFIG_MAX_PLAYER_LEVEL) + 3.', @GMLEVEL_MODERATOR),
('npc set model', 'Syntax: .npc set model $displayid', 'Change the model id of the selected creature to $displayid.', @GMLEVEL_MODERATOR),
('npc set phase', 'Syntax: .npc set phase $phasemask', 'Selected unit or pet phasemask changed to $phasemask with related world vision update for players. In creature case state saved to DB and persistent. In pet case change active until in game phase changed for owner, owner re-login, or GM-mode enable/disable..', @GMLEVEL_MODERATOR),
...
('npc textemote', 'Syntax: .npc textemote $emoteid', 'Make the selected creature to do textemote with an emote of id $emoteid.', @GMLEVEL_MODERATOR),
('npc whisper', 'Syntax: .npc whisper $playerguid $text', 'Make the selected npc whisper $text to  $playerguid.', @GMLEVEL_MODERATOR),
